...
@Component({
  selector: "approved-or-reject",
  templateUrl: "./approved-or-reject.component.html",
})
export class ApprovedOrRejectComponent implements OnInit {
